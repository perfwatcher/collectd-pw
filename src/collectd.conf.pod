...
Example :
 ...
 <Plugin "nfs">
   enable_client_stats_per_mountpoint <true|false>
   <mountpoint "all">
     min_age 3600
     enable true
   </mountpoint>
...
=item B<enable_client_stats_per_mountpoint> I<boolean>
...
=head2 Plugin C<rrdtool_createonly>

Same as rrdtool (same options).
However, it will only create file that does not exist.
You need to use the plugin rrdtool or rrdcached to fill the rrdfiles.
